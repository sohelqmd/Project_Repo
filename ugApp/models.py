...
# Create your models here.
class UGInstitute(models.Model):
    UG_id = models.PositiveIntegerField(primary_key=True)
    ...
    def str(self):
        return self.UG_institute_name
    
class UGContactInformation(models.Model):
    UG_contact_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, null=True,  on_delete=models.CASCADE)
    ...
    def str(self):
        return self.UG_contact_person
   
class UGLocationInformation(models.Model):
    UG_location_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, null=True,  on_delete=models.CASCADE)
...
class UG_Course_Chocies(models.Model):
    UG_course_no = models.PositiveIntegerField(primary_key=True)
    UG_course_name = models.CharField(max_length=50)

    def str(self):
        return self.UG_course_name
    
class UGCourseForm(models.Model):
    ...
    UG_course_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, on_delete=models.CASCADE)
    UG_courses = models.ForeignKey(UG_Course_Chocies, on_delete=models.CASCADE)
...
class UGTrainer(models.Model):
    UG_trainer_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, on_delete=models.CASCADE)
    UG_courses = models.ForeignKey(UG_Course_Chocies, on_delete=models.CASCADE)
    ...
    def str(self):
        return self.UG_trainer_name





class UGFacilitiesAndInfrastructure(models.Model):
    UG_facilities_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, null=True,  on_delete=models.CASCADE)
...
class UGTopRankInfo(models.Model):
    UG_topranks_id=models.IntegerField(primary_key=True)
    UG_institute=models.ForeignKey(UGInstitute,on_delete=models.CASCADE)
...
class UGAdmissionProcess(models.Model):
    UG_admission_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, null=True,  on_delete=models.CASCADE)
...
class UGContactAndSupportForm(models.Model):
    UG_support_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, null=True,  on_delete=models.CASCADE)
...
class UGAdditionalInformation(models.Model):
    UG_additional_id = models.PositiveIntegerField(primary_key=True)
    UG_institute = models.ForeignKey(UGInstitute, null=True,  on_delete=models.CASCADE)
