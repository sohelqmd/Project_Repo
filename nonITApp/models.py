...
class Non_ItInstitute(models.Model):
    NonIt_id = models.PositiveIntegerField(primary_key=True)
    ...
    def str(self):
        return self.Nonit_institute_name
    
class Non_ItContactInformation(models.Model):
    Nonit_contact_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True,  on_delete=models.CASCADE)
    ...
    def str(self):
        return self.Nonit_contact_person
    
class Non_ItLocationInformation(models.Model):
    Nonit_location_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True,  on_delete=models.CASCADE)
...
class Non_It_Course_Chocies(models.Model):
    Nonit_course_no = models.PositiveIntegerField(primary_key=True)
    Nonit_course_name = models.CharField(max_length=50)

    def str(self):
        return self.Nonit_course_name
    
class Non_ItCourseForm(models.Model):
    ...
    Nonit_course_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, on_delete=models.CASCADE)
    Nonit_courses = models.ForeignKey(Non_It_Course_Chocies, on_delete=models.CASCADE)
    ...
    #def str(self):
        #return self.it_courses
    
class Non_ItTrainer(models.Model):
    NonIt_trainer_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, on_delete=models.CASCADE)
    Nonit_courses = models.ForeignKey(Non_It_Course_Chocies, on_delete=models.CASCADE)
    ...
    def str(self):
        return self.Nonit_trainer_name

class Non_ItPlacementDetails(models.Model):
    NonIt_Placement_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True, on_delete=models.CASCADE)
    placement_statistics = models.DecimalField(max_digits=5,
        decimal_places=2,null=True,blank=True,
        validators=[MinValueValidator(0)],
        help_text="Enter placement success rate (%)")
    placement_count = models.PositiveIntegerField(null=True)
    companies_associated = models.TextField(null=True,blank=True,
        help_text="Enter names of companies associated with placements")
    placement_process = models.TextField(null=True,blank=True,
    ...
    internship_opportunities = models.TextField(null=True,blank=True,
...
class Non_ItFacilitiesAndInfrastructure(models.Model):
    Nonit_facilities_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True,  on_delete=models.CASCADE)
...
class Non_ItAdmissionProcess(models.Model):
    Nonit_admission_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True,  on_delete=models.CASCADE)
...
class Non_ItContactAndSupportForm(models.Model):
    Nonit_support_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True,  on_delete=models.CASCADE)
...
class Non_ItAdditionalInformation(models.Model):
    Nonit_additional_id = models.PositiveIntegerField(primary_key=True)
    Nonit_institute = models.ForeignKey(Non_ItInstitute, null=True,  on_delete=models.CASCADE)
